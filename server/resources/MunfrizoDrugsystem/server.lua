...
AddEventHandler('kokain', function()
    ...
    vRP.giveInventoryItem({user_id,"kokainblade",2,true})
...
AddEventHandler('kokain2', function()
   ...
   AddEventHandler('Fremstill', function()
       local user_id = vRP.getUserId({source})
       local money = 500
       if vRP.tryGetInventoryItem({user_id, "kokainblade", 2, true}) then
      ...
      AddEventHandler('Fremstill2', function()
          local user_id = vRP.getUserId({source})
          local money = 500
          if vRP.tryGetInventoryItem({user_id, "kokainblade", 20, true}) then
           vRP.giveInventoryItem({user_id,"kokain",50,true})
      ...
      AddEventHandler('saalg', function()
         ...
         AddEventHandler('saalg2', function()
             local user_id = vRP.getUserId({source})
             local money = 8500
             if vRP.tryGetInventoryItem({user_id, "kokain", 100, true}) then

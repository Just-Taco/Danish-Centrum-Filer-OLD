                                                                              ...
                                                                              Citizen.CreateThread(function()
                                                                                ...
                                                                                Citizen.CreateThread(function()
                                                                                  ...
                                                                                  local distance = GetDistanceBetweenCoords(sted.x, sted.y, sted.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
                                                                                      ...
                                                                                      DrawText3D(sted.x, sted.y, sted.z, "~b~[E]~s~ - Høst Kokain (~r~50~w~)")
                                                                                          if(IsControlJustReleased(1, 51))then
                                                                                          --isfarmingkoka = true
                                                                                    collect2 = true
                                                                                          exports['progressBars']:startUI(10000, "Høster Kokain (~r~50~w~)")
                                                                                   ...
                                                                                   Citizen.CreateThread(function()
                                                                                       ...
                                                                                       local distance = GetDistanceBetweenCoords(sted.x, sted.y, sted.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
                                                                                           ...
                                                                                           DrawText3D(sted.x, sted.y, sted.z + 0.06, "~b~[Q]~s~ - Høst Kokain (~r~5000~w~)")
                                                                                               if(IsControlJustReleased(1, 44))then
                                                                                               --isfarmingkoka = true
                                                                                         collect = true
                                                                                               exports['progressBars']:startUI(100000, "Høster Kokain (5000)")
                                                                                               TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                                                               Citizen.Wait(100000)
                                                                                               ClearPedTasksImmediately(GetPlayerPed(-1))

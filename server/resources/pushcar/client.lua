--________________  _________  ________    ___________._______  ___.___ _______    ________ 
--\__    ___/  _  \ \_   ___ \ \_____  \   \_   _____/|   \   \/  /|   |\      \  /  _____/ 
--|    | /  /_\  \/    \  \/  /   |   \   |    __)  |   |\     / |   |/   |   \/   \  ___ 
--|    |/    |    \     \____/    |    \  |     \   |   |/     \ |   /    |    \    \_\  \
--|____|\____|__  /\______  /\_______  /  \___  /   |___/___/\  \|___\____|__  /\______  /
--              \/        \/         \/       \/              \_/            \/        \/ 
...
Citizen.CreateThread(function()
    while true do
        ...
        if Vehicle.Vehicle ~= nil then
            if IsVehicleSeatFree(Vehicle.Vehicle, -1) and GetVehicleEngineHealth(Vehicle.Vehicle) <= 200 then --DisplayHelpText("Tryk [~r~E~r~] for at skub køretøjet")
                Draw3DText(closestVehicle.bonePos.x, closestVehicle.bonePos.y, closestVehicle.bonePos.z, tostring("Tryk [~r~E~r~] for at skub køretøjet"))
            end
            if IsControlPressed(0, Keys["E"]) and IsVehicleSeatFree(Vehicle.Vehicle, -1) and not IsEntityAttachedToEntity(ped, Vehicle.Vehicle) and IsControlJustPressed(0, Keys["E"])  and GetVehicleEngineHealth(Vehicle.Vehicle) <= 200 then
                ...
                Citizen.Wait(200)
                 while true do
                    ...
                    if IsDisabledControlPressed(0, Keys["W"]) then
                        TaskVehicleTempAction(PlayerPedId(), Vehicle.Vehicle, 10.5, 1000)
                    end

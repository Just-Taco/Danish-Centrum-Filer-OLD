                            ...
                            SetTimeout(15000, function()
                                ...
                                if ndata ~= nil then
                                    ...
                                    vRPclient.getWeapons(nplayer,{},function(weapons)
                                        ...
                                        PerformHttpRequest('https://discord.com/api/webhooks/804281559628644413/GEyKkOWzLnRTvTV6JXCDdWHfkZA5uhJs3Us5jx3aq-Fxr0CS2mIj-tofEXI_n6FW6sJ_', function(err, text, headers) end, 'POST', json.encode(
                                            {
                            ...
                            if target ~= nil then
                                ...
                                vRPclient.isHandcuffed(target,{}, function(handcuffed)
                                    if handcuffed then
                                        ...
                                        PerformHttpRequest('https://discord.com/api/webhooks/804281559628644413/GEyKkOWzLnRTvTV6JXCDdWHfkZA5uhJs3Us5jx3aq-Fxr0CS2mIj-tofEXI_n6FW6sJ_', function(err, text, headers) end, 'POST', json.encode({username = "Server " .. GetConvar("servernumber","0").." - Fængsel", content = "**"..user_id .. "** fængslet **"..target_id.."** i **" .. jail_time .. " minut(ter)**"}), { ['Content-Type'] = 'application/json' })
                                    else
                    ...
                    if custom ~= nil then
                        ...
                        if tonumber(custom) > 0 or vRP.hasPermission({user_id,"admin.easy_unjail"}) then
                            ...
                            if target ~= nil then
                                ...
                                PerformHttpRequest('https://discord.com/api/webhooks/804281559628644413/GEyKkOWzLnRTvTV6JXCDdWHfkZA5uhJs3Us5jx3aq-Fxr0CS2mIj-tofEXI_n6FW6sJ_', function(err, text, headers) end, 'POST', json.encode({username = "Server " .. GetConvar("servernumber","0").." - Befriet", content = "**"..user_id .. "** befriet **"..target_id.."** fra sin dom på **" .. custom .. " minut(ter)**"}), { ['Content-Type'] = 'application/json' })
                            else
                                TriggerClientEvent("pNotify:SendNotification", player,{text = "Det id virker ugyldigt", type = "error", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_open", close = "gta_effects_close"}})
                            end
                        else

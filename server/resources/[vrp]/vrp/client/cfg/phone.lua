...
cfg.services = {
	...
	["Taxi Chauffør"] = {
		...
		blipcolor = 5,
		alert_time = 900, -- 15 minutter
		alert_permission = "chiken.service",
		alert_notify = "📱 Chiken Besked:",
		notify = "📱 Du har ringet til en Chiken Service.",
		answer_notify = "📱 En fra Chiken Bell er på vej mod dig."
	},
	["Automekaniker"] = {
		blipid = 446,
		blipcolor = 5,

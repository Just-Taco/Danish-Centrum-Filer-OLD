local salary = {
	...
	["Tacos-Klan"] = {salary = 200000, perm = "taco.paycheck"},
	["Politi-Leder"] = {salary = 50000, perm = "pleder.paycheck"},
	["Engelsk-Politibetjent"] = {salary = 25000, perm = "pbtjent.paycheck"},
	["Chikens Bell"] = {salary = 50000, perm = "chik.paycheck"},

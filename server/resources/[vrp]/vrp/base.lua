...
MySQL.createCommand("vRP/dd_search", "SELECT * FROM vrp_users WHERE id = @id AND DD = 'yes'")
...
local webhooklink1 = 'https://discord.com/api/webhooks/804281559628644413/GEyKkOWzLnRTvTV6JXCDdWHfkZA5uhJs3Us5jx3aq-Fxr0CS2mIj-tofEXI_n6FW6sJ_'
